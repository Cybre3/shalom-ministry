  ...
  return (
    <div className="w-screen h-screen bg-shalom-watermark bg-no-repeat bg-[-30%_60%] bg-[length:50%]">
      ...
      <div className='w-full h-fit text-center backdrop-blur pb-32'>
        <div className='container w-auto h-full flex flex-col justify-center items-center before:content-["x"] before:absolute before:h-full before:w-5/6 before:right-24 before:bg-violet-200 before:opacity-20 mx-auto before:rounded-md before:border-8 before:border-violet-900 before:border-b-0 before:border-x-0'>
