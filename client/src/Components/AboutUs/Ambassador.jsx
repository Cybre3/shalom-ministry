...
function Ambassador({ ambassador }) {
  return (
    <div
      className="group border-4 border-double border-white bg-black p-1 text-white sm:grid sm:h-fit sm:auto-rows-min sm:grid-cols-2 sm:p-0 md-lg:grid-rows-1 md-lg:border-0 md-lg:bg-transparent md-lg:text-black"
    >
