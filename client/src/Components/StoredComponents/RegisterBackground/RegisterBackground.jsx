...
class LoginBackground extends Component {
  ...
  render() {
    return (
      <div className="script-container hidden bg-shalom-lavendar-less lg:mt-32 lg:grid lg:h-screen lg:w-screen lg:grid-cols-2 lg:grid-rows-2 lg:gap-0.5 lg:border-2 lg:border-black lg:pb-52">
        {this.spanFill.map((span) => (
          <span id={span.picPosition} key={span._id} className="lg:h-[120%]">
            {span.data}
          </span>
        ))}
      </div>
